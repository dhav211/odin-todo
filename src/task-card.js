...
function setTextArea(task, isComplete) {
    ...
    if (!isComplete) {
        if (typeof task.dueDate === "string") {
            ...
            taskDueDate.textContent = task.dueDate.toLocaleString(DateTime.DATE_SHORT);
        }
    }
...
function setEditButton(taskCard, task) {
    ...
    editButton.addEventListener("click", () => {
        PubSub.publish("openEditTaskBox", {taskCard: taskCard, taskBox: createEditTaskBox(task)});
    });
...
function setCompleteButton(task) {
    ...
    completeButton.addEventListener("click", () => PubSub.publish("taskCompleted", task));
...
function setRemoveButton(task) {
    ...
    removeButton.addEventListener("click", () => PubSub.publish("removeTask", task));
