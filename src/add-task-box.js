...
function addTask() {
  PubSub.publish("addTask", {
    project: addTaskBox.inputs.project,
    task: new Task(
      addTaskBox.inputs.name,
      addTaskBox.inputs.description,
      addTaskBox.inputs.dueDate,
      addTaskBox.inputs.urgency,
      addTaskBox.inputs.project,
    ),
  });
  closeAddTaskBox();
}
